  ...
  return (
    <footer className='footer-container'>
      ...
      <div className='socials'>
        <div><a href="https://www.facebook.com/"  target="blank"><BsFacebook className='social-icon fb'/></a></div>
        <div><a href='https://web.whatsapp.com/' target="blank"><BsWhatsapp className='social-icon whatsapp'/></a></div>
