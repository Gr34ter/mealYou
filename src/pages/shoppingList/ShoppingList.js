            ...
            <div>
                            ...
                            <ul>
                                {items.map((item, i) => (
                                    <div className='list-item-container' key={item}>
                                        <li>{item}</li>
                                        <div className='not-complete' onClick={() => handleClick(i)} id={`${i}-item`}>
                                            <ImCheckboxChecked />
                                        </div>
                                    </div>
                                ))}
                ...
                {items.length === 0 && (
                    <div className='shopping-list-info'>
                        <h4 className='shopping-list-info-header'>No items in shopping list yet...</h4>
                        
                        <p className='shopping-list-info-text'>
                            Looks like you didnt plan your meals yet. 
                        <br></br>
                            Visit your <span className='lint-text'>Meals Book</span> and add recipes to the <span className='lint-text'>Planner.</span>
