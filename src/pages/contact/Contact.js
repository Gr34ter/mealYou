...
function Contact() {
    ...
    useEffect(() => {
        console.log(`Socials view is: ${socialsInView}`, `Contact view is: ${contactInView}`);
        if (socialsInView) {
  ...
  return (
    <div className='contact-wrapper'>
        ...
        <div className='contact-page-infos'>
            <div className='idea page-info'>
                <motion.img 
                    ...
                    animate={{x: 0 }}
                    transition={{
                        type: 'spring', duration: 0.3, bounce: 0.3, delay: 0.6, stiffness: 80
                    }}
                />
            ...
            <div className='support page-info'>
                <motion.img 
                    ...
                    animate={{x: 0 }}
                    transition={{
                        type: 'spring', duration: 0.3, bounce: 0.3, delay: 1, stiffness: 80
                    }}
                />
                <h4>Get support</h4>
            </div>
            <div className='community page-info'>
                <motion.img 
                    ...
                    animate={{x: 0 }}
                    transition={{
                        type: 'spring', duration: 0.3, bounce: 0.3, delay: 1.4, stiffness: 80
                    }}
                />
        ...
        <motion.div className='contact-page-details' >
            <div ref={refContact}>
                ...
                <motion.div className='message-info'>
                    ...
                    <p>tel: 123 456 789</p>
                    <motion.img src={message} alt="message" className='contact-info-icon' animate={contactAnimation} />
                </motion.div>
            </div>        
        ...
        <motion.div 
            className='contact-page-socials' 
            ref={refSocials}
        >
            <motion.div 
                className='contact-page-icon-container'
