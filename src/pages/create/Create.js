...
export default function Create () {
    ...
    const customStyles = {
        control: (styles, {isFocused}) => {
            ...
            cursor: 'pointer',
            border: isFocused? "3px solid var(--text-color-light)" : "3px solid var(--text-color-light)",
            ':hover':{
        ...
        <div className='create-wrapper'>
            <form className='meal-form-container' onSubmit={handleSubmit}>
                ...
                <div className='create-details-wrapper'>
                    ...
                    <label className='cookingTime-label'>
                    ...
                    <label>
                        ...
                        <div className='create-ingredients-container'>
                            <input
                                ...
                                className="ing-input"
                            />
                            <button className='add-ing-btn' onClick={handleAdd}><AiOutlinePlusCircle/></button>
                ...
                <div className='create-prep-details'>
                    <label>
                        <span>Notes and preparation (optional):</span>
                        <textarea
